      ...
      <div className="min-h-screen pb-20">
        ...
        <nav className="z-50 flex items-center justify-between w-full py-4 px-6 md:px-16 lg:px-24 xl:px-40 text-sm">
          ...
          <div className="hidden md:flex items-center gap-8 transition duration-500 text-slate-800">
            ...
            <a href="#cta" className="hover:text-orange-600 transition">
              Contact
            </a>
          </div>
        ...
        <div className="relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-black">
                ...
                {Array(5)
                  ...
                  .map((_, i) => (
                    <svg
                      ...
                      className="lucide lucide-star text-transparent fill-orange-600"
                      aria-hidden="true"
                    >
          ...
          <h1 className="text-5xl md:text-6xl font-semibold max-w-5xl text-center mt-4 md:leading-[70px]">
            ...
            <span className=" bg-linear-to-r from-orange-700 to-orange-600 bg-clip-text text-transparent text-nowrap">
              AI-powered{" "}
            </span>{" "}
            resumes.
          </h1>
          ...
          <div
            ...
            id="logo-container"
          >
            <div className="flex flex-wrap items-center justify-center gap-12  max-md:px-2">
              <svg
                width="90"
                height="32"
                viewBox="0 0 90 32"
